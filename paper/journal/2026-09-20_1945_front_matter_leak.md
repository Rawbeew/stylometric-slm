...
3. Restart VM, re-launch training ✓ LAUNCHED
4. (Defensive) Update `train_mt5.py` to enable `max_grad_norm=1.0` so future gradient explosions don't blow up training
